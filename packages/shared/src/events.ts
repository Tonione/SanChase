import { z } from "zod";
import { ActionEventSchema, CoordinatesSchema, CopRadarSchema, GameStateSchema, RoomSettingsSchema } from "./domain.js";
...
export const ClientMessageSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("join_room"), roomId: z.string(), playerId: z.string(), name: z.string(), reconnectToken: z.string().optional() }),
  ...
  z.object({ type: z.literal("deploy_cop_radar"), roomId: z.string(), by: z.string() }),
  ...
  z.object({ type: z.literal("dev_reset_room"), roomId: z.string(), by: z.string() }),
  z.object({ type: z.literal("organizer_reset_game"), roomId: z.string(), by: z.string() }),
  z.object({ type: z.literal("organizer_quit_game"), roomId: z.string(), by: z.string() }),
...
export const PlayerViewSchema = z.object({
  copRadars: z.array(CopRadarSchema),
  radarDetections: z.array(z.object({ radarId: z.string(), position: CoordinatesSchema })),
  radarRangeM: z.number().positive()
});
...
export const ServerMessageSchema = z.discriminatedUnion("type", [
  z.object({
    ...
    playerView: PlayerViewSchema.optional()
  }),
  ...
  z.object({ type: z.literal("room_closed"), reason: z.string() })
]);
