...
export const ClientMessageSchema = z.discriminatedUnion("type", [
  ...
  z.object({ type: z.literal("complete_mission_hold"), roomId: z.string(), by: z.string(), missionId: z.string() }),
  z.object({ type: z.literal("location_update"), roomId: z.string(), playerId: z.string(), location: CoordinatesSchema }),
