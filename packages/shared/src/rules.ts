...
export const MISSION_NAMES = [
  ...
  "Slammer comme Orelsan",
  "Marraver avec une petit cuillère",
  "Avoir 3 podcasts prêts en avance",
  "Tromper le chef de la police foireux",
  "Regarder passer le tram",
  "Entuber un fond d'investissement",
  "Battre un record d'escape",
  "Mettre à jour Time2Escape",
  "Sorger un inconnu",
  "Chanter le ranz des vaches",
  "Ne pas oublier ses rêves",
  "Faire preuve de charisme emotif",
  "Expulser un kyste",
  "Se remettre d'un onion pelé",
  "Faire quatre",
  "Faire du buzz sur LinkedIn",
  "Raconter des histoires aux toilettes",
  "Recompter les dents d'un timbre",
  "Se faire encucquer",
] as const;
