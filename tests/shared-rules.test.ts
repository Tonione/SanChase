...
describe("shared rules", () => {
  ...
  it("reports rally progress before chase start", () => {
    const state = createInitialState("roomx");
    state.phase = "rally";
    state.players.a = { id: "a", name: "A", role: "hunter", connected: true, ready: true, reachedRally: true, usedNoisePing: false, usedDecoyPower: false, copScanUses: 0, arrestAttemptsUsed: 0, lastLocation: null, cooldowns: { sonar_ping: 0, jam: 0, fake_clue: 0 } };
  ...
  it("allows fugitive to scan cops twice for three minutes", () => {
    ...
    state.phase = "active";
    state.fugitiveId = "fug1";
    state.players.fug1 = { id: "fug1", name: "F", role: "hunter", connected: true, ready: true, reachedRally: true, usedNoisePing: false, usedDecoyPower: false, copScanUses: 0, arrestAttemptsUsed: 0, lastLocation: null, cooldowns: { sonar_ping: 0, jam: 0, fake_clue: 0 } };
